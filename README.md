...
# Hi there! I'm Saketh Lingerker ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif) 
...
I’m a passionate **Computer Science Engineer** specializing in **AI/ML systems, intelligent automation, and scalable full-stack development**.  
I completed my B.Tech from **JNTUH (2021–2025)** and love turning ideas into real-world tech that actually makes impact.

I previously worked as an **AI Research Intern at IIIT Hyderabad**, where I contributed to:
- 🎧 **Voice Activity Detection (VAD) systems**
- 🧠 **Transformer-based Intelligent Solutions**
- ⚙️ Model design → evaluation → deployment

---

## ⚡ Highlights

- 🚀 Built multiple AI products — from resume intelligence tools to real-time AI applications  
- 🧪 Research exposure in **Speech Processing & Transformers**  
- 🧑‍🤝‍🧑 Experience working in teams + leading initiatives  
- 🧭 Led communities: **Coding Club Mentor & College Fest Technical Coordinator**
...
| Project | Description | |
|--------|-------------|--|
| **Vehicle Insurance MLOps Pipeline** | Fully automated ML pipeline for data → model → monitoring | 🔗 [Repo](https://github.com/sakethlingerker/MLOPS-Project) |
...
| **Flight Fare Predictor** | Predicts ticket prices in real-time | 🔗 [Repo](https://github.com/sakethlingerker/Flight-Price-Prediction) |

### 🌐 **Web**
| Project | Description | |
|--------|-------------|--|
| **Smart Feedback System** | AI-powered feedback analysis platform | 🔗 [Repo](https://github.com/sakethlingerker/Smart-Feedback-Collection-and-Analysis-System) |
| **Cloudcast Weather App** | Modern UI + Live weather with 5-day forecast | 🔗 [Live](https://sakethlingerker.github.io/Cloudcast---Advanced-Weather-Application/) |

### 📊 **Data Science**
| Project | Description | |
|--------|-------------|--|
| **ClearView Air Quality Insights** | Interactive AQI analytics dashboard | 🔗 [Live](https://air-quality-insight.streamlit.app/) |

<p align="center">
📖 More here → <a href="https://sakethlingerker.github.io/Portfolio/">Portfolio</a> <br>
📄 Resume → <a href="https://github.com/sakethlingerker/Portfolio/blob/main/assets/Saketh_Lingerker_8688791352.pdf">Download</a>
</p>
...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-000000?style=for-the-badge&)](https://sakethlingerker.github.io/Portfolio/)
[![LinkedIn](https://img.shields.io/badge/_LinkedIn-0077B5?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/sakethlingerker)
