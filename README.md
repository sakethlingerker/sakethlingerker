...
* **AI/ML Projects:** Developed an **ATS Resume Expert Pro** (using **Google Gemini AI**) and a **Smart Feedback Collection and Analysis System** (using **Flask** and **Hugging Face**).
* **Research Focus:** Engineered Voice Activity Detection (VAD) modules in Python for AI-driven video summarization systems and gained expertise in transformer architectures.
* **Soft Skills:** Proven ability in **Problem Solving**, **Team Collaboration**, **Leadership**, and **Technical Communication**.
* **Leadership:** Served as a **Coding Club Mentor** and **Technical & Main Coordinator** for the College Fest.
